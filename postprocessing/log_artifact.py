...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Local path to the file or directory to log",
    )
    parser.add_argument("--experiment", default=None, help="MLflow experiment name")
    parser.add_argument(
        "--run-id",
        default=None,
        help="Log into this existing run instead of creating a new one",
    )
    ...
    parser.add_argument(
        "--artifact-path",
        default=None,
        help="Subdirectory inside the run's artifact root",
    )
    parser.add_argument(
        "--metric",
        nargs=2,
        ...
        action="append",
        default=[],
        help="Log a metric (repeatable: --metric key1 val1 --metric key2 val2)",
    )
