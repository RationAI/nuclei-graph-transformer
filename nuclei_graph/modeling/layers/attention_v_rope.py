...
class RotarySparseAttentionVRope(nn.Module):
    """Identical to RotarySparseAttention, except V is also rotated by RoPE.

    Used for the blank-token position/attention-only ablation.
    """
